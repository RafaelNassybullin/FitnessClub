...
function Navbar(props) {
    ...
    return (
        <Header  {...props}
                 style={{
                     background: get ? '#FFFFFF99' : 'unset',
                     backdropFilter: get ? 'saturate(180%) blur(20px)' : 'unset',
                     height: get ? '5.75vw' : '3.750vw'
                 }}
                 animate={{
                     top: get ? '0' : '1.625vw',
                     y: scrollY < 700 ? '0' : lastYposOne ? '0' : '-5.75vw',
                 }}>
            <nav>
                <Logo>
                ...
                <motion.ul variants={animUl} animate={get ? 'open' : 'close'}>
                    <li>home</li>
                    <li>training</li>
                    <li>contact</li>
                </motion.ul>
                <Burger {...props} animate={{
                    ...
                    background: scrollY > 300 ? '#FF2625' : '#fff'
                }}>{}</Burger>
            </nav>
        </Header>
    );
